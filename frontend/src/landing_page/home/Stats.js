        ...
        <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>No gimmicks,spam,"gamification",or annoying push notifications.High quality apps that you use at pace,the way you like. Our philosophies.</p>
