                ...
                <div className="row text-center">
                    ...
                    <p>Extend your trading and investment experience even further with our partner platforms
                        ...
                        <div className="col-4 p-3 mt-5">
                            ...
                            style={{width:"100%",maxHeight:"80px",objectFit:"contain"}}
                                ...
                                <p className="text-small text-muted">Systematic trading platform
                                    that allows you to create and backtest strategies without coding.</p>
                        </div>
                        ...
                        <div className="col-4 p-3 mt-5">
                            ...
                            style={{width:"100%",maxHeight:"80px",objectFit:"contain"}}
                                />
                                <p className="text-small text-muted">Options trading platform that lets you create strategies, analyze positions, and examine data points like open interest, FIl/DIl, and more.</p>
                        </div>
                        ...
                        <div className="col-4 p-3 mt-5">
                            ...
                            style={{width:"100%",maxHeight:"80px",objectFit:"contain"}}
                                ...
                                that is creating simple and transparent index funds to help you save for your goals.</p>
                        </div>
