            ...
            <div className="row p-5 mt-5 mb-5">
                <h1 className="fs-2">To create a ticket, select a relevant topic</h1>
                    <div className="col-4 p-5 mt-2 mb-2">
                        <h4 className=""> <i class="fa fa-plus-circle"></i> Acoount Opening</h4>
                            ...
                            <br/>
                            <a href="" style={{textDecoration:"none" ,lineHeight:"2.5"}}>Comapny, Partnership and HUF Account Opening</a>
                            <br/>
                    ...
                    <div className="col-4 p-5 mt-2 mb-2">
                        <h4 className=""> <i class="fa fa-user-circle" aria-hidden="true"></i> Your Zerodha Account</h4>
                    ...
                    <div className="col-4 p-5 mt-2 mb-2">
                        <h4 className=""> <i class="fa fa-credit-card" aria-hidden="true"></i> Funds</h4>
                            ...
                            <br/>
                            <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Adding Banks Accounts</a>
                    ...
                    <div className="col-4 p-5 mt-2 mb-2">
                        <h4 className=""> <i class="fa fa-circle" aria-hidden="true"></i> Coin</h4>
                            <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Understanding Mutual Funds</a>
                            <br/>
                            <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Aboiut Coin</a>
                            <br/>
